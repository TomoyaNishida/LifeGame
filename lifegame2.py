...
class Main:
    ...
    def __init__(self):
        ...
        self.lg = LifeGame(L, rule, p=True, pattern=pattern)
    ...
    def one_step(self):
        self.lg.progress(self.DrawCanvas.canvas_update, self.DrawCanvas.update, onestep =True)
